...
private:
    ...
    // --- Magic Bitboard Data ---
    static std::array<Bitboard, NUM_SQUARES_BB> rook_masks_;
    static std::array<Bitboard, NUM_SQUARES_BB> bishop_masks_;
    static std::array<int, NUM_SQUARES_BB> rook_shift_bits_;     // Precomputed shifts
    static std::array<int, NUM_SQUARES_BB> bishop_shift_bits_;   // Precomputed shifts
    
    static std::vector<Bitboard> rook_attack_table_;             // Flat table for all rook attacks
    static std::vector<Bitboard> bishop_attack_table_;           // Flat table for all bishop attacks
    static std::array<unsigned int, NUM_SQUARES_BB> rook_attack_offsets_; // Offsets into rook_attack_table_
    static std::array<unsigned int, NUM_SQUARES_BB> bishop_attack_offsets_;// Offsets into bishop_attack_table_
    ...
    // REMOVED: void generate_sliding_moves(...); This is now handled by magic bitboards at runtime
    // and by calculate_..._attacks_on_the_fly during initialization.
