...
class EngineHandler:
    ...
    """
    def __init__(self, binary_path, model_path, sims, batch_size, spite_weight):
        self.binary_path = binary_path
        self.model_path = model_path
        self.sims = sims
        self.batch_size = batch_size
        self.spite_weight = spite_weight
        self.process = None
        self._start_process()
...
class GameController:
    def __init__(self, my_color: str, model_path: str, sims: int, batch_size: int, spite: float):
        self.my_color = my_color.upper() # R, B, Y, or G
        self.board_moves = []
        self.geometry = None
        
        # Initialize engine
        self.engine = EngineHandler(ENGINE_BINARY, model_path, sims, batch_size, spite)
...
if __name__ == "__main__":
    ...
    parser.add_argument('--spite', type=float, default=0.0, help="Spite weight (0.0 to 1.0)")
    ...
    # Start Controller
    controller = GameController(args.color, args.model, args.sims, args.batch, args.spite)
